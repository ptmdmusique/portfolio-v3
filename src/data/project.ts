...
export const techStackInfo = {
  ...
  qrScheduling: { icon: ["fas", "qrcode"], displayName: "QR Scheduling" },
  gcp: { icon: ["fab", "google"], displayName: "GCP" },
  ibmChatbot: { icon: ["fas", "comment"], displayName: "IBM Chatbot" },
  unity: { icon: ["fab", "unity"], displayName: "Unity 3D" },
  python: { icon: ["fab", "python"], displayName: "Python" },
  arFoundation: { icon: ["fas", "vr-cardboard"], displayName: "AR Foundation" },
  cSharp: { icon: ["fas", "code"], displayName: "C#" },
  ...
  chemistry: { icon: ["fas", "atom"], displayName: "Chemistry" },
  pixelArt: { icon: ["fas", "palette"], displayName: "Pixel Art" },
